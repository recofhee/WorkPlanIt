			...
			if(email==null || email.equals(""))
				response.sendRedirect("../index.jsp");
				    ...
				    if (count > 0) {
				        ...
				        bestList = dbPro.getBest_Articles(startRow, pageSize); //따로 카운트 만들어야되나??
				        newsList = dbPro2.getNews(startRow, pageSize, mem_num); //따로 카운트 만들어야되나??
				    }
	...
	<% } else {%>
		...
		<article class="post">
			...
			<div class="title row" style="padding: 0.2%; margin-bottom: 4%;">
				<div class="btn-group" style="padding-left: 0px; margin-left: 0px;">
				  ...
				  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
				    <li><a href="commu.jsp">최신순</a></li>
				    <li><a href="commu.jsp?page=order_view">조회순</a></li>
				    <li><a href="commu.jsp?page=order_save">관심순</a></li>
				  </ul>
		        </div>
			...
			<div class="title row"> <!-- 여기가 반복 -->
				<p style="font-size: 14px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 400px;"><a href="commu.jsp?page=contents&num=<%=article.getBoard_num()%>&pageNum=<%=currentPage%>"><%=article.getBoard_title()%></a></p>
			...
			<article class="mini-post">
				<header>
					...
					<div class="row" style="padding-left: 2%; padding-top: 10px;">
						...
						<a href="commu.jsp?page=list_save" class="btn published"><i class="icon fa fa-star"></i> 관심글</a>
