      ...
      <div class="row mpmarginbottom">
        ...
        <div class="col-sm-6">
          ...
          <div id="sb-search" class="sb-search">
            <form method="get" class="form-inline" name="saform" action="saPro.jsp?plnaet_num=<%=planetInfo.getPlanet_num()%>">
		...
		<% } else {
			for (int i = 0 ; i < articleList.size() ; i++) {
				PlanetDataBean article = articleList.get(i);
		%>
		<article id="post" class="post type-post status-publishhentry">
          ...
          <div class="entry-meta">
			...
			<h2 class="entry-title">
	          	<a href="myplanetarticle.jsp?planet_num=<%=article.getPlanet_num()%>&num=<%=article.getPlanet_cont_num()%>&pageNum=<%=currentPage%>">
